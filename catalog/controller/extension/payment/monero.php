<?php
    ...
    class ControllerExtensionPaymentMonero extends Controller {
        ...
        public function index() {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/extension/payment/monero.twig')) {
                $this->template = $this->config->get('config_template') . '/template/extension/payment/monero.twig';
            } else {
                $this->template = 'default/template/extension/payment/monero.twig';
            }
